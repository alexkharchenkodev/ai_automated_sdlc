...
$requiredFiles = @(
    ...
    "tools/ai-sdlc/scripts/run-ai-sdlc-executor.ps1",
    "tools/ai-sdlc/scripts/submit-role-artifact.ps1",
    "tools/ai-sdlc/scripts/verify-task-decomposition.ps1",
    "tools/ai-sdlc/scripts/write-task-decomposition.ps1",
